...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_30442u9yjg8yow7a.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_ddl6jd9ujg8yow6h.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_bswmnw9wjg8yow6j.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_3rp0kc9zjg8yow7b = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_c46lcz9tjg8yow6f = {
    open: function (editor) {
      var minWidth = $_ddl6jd9ujg8yow6h.getDialogMinWidth(editor);
      var minHeight = $_ddl6jd9ujg8yow6h.getDialogMinHeight(editor);
      var currentLanguage = $_3rp0kc9zjg8yow7b.getCurrentLanguage(editor);
      var currentLanguages = $_3rp0kc9zjg8yow7b.getLanguages(editor);
      var currentCode = $_bswmnw9wjg8yow6j.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_bswmnw9wjg8yow6j.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_30442u9yjg8yow7a.isCodeSample(node)) {
        $_c46lcz9tjg8yow6f.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_7p8p19sjg8yow6e = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_30442u9yjg8yow7a.trimArg($_30442u9yjg8yow7a.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_30442u9yjg8yow7a.trimArg($_30442u9yjg8yow7a.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_cdgbmga0jg8yow7e = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_ddl6jd9ujg8yow6h.getContentCss(editor);
  ...
  var $_6jgvgva1jg8yow7g = { loadCss: loadCss };
  ...
  var $_8wf3gaa2jg8yow7h = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_cdgbmga0jg8yow7e.setup(editor);
    $_8wf3gaa2jg8yow7h.register(editor);
    $_7p8p19sjg8yow6e.register(editor);
    editor.on('init', function () {
      $_6jgvgva1jg8yow7g.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_30442u9yjg8yow7a.isCodeSample(ev.target)) {
        $_c46lcz9tjg8yow6f.open(editor);
      }
    });
  });
