...
var textpattern = (function () {
  ...
  var $_a0gj4qr0jg8yozr2 = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_es3vtjr8jg8yozrc.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_es3vtjr8jg8yozrc.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_es3vtjr8jg8yozrc.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_ezuyvxr5jg8yozr9.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_ezuyvxr5jg8yozr9.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_ezuyvxr5jg8yozr9.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_e4md16r4jg8yozr6.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_e4md16r4jg8yozr6.checkKeyCode(keyCodes, e)) {
        $_e4md16r4jg8yozr6.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_e4md16r4jg8yozr6.checkCharCode(charCodes, e)) {
  ...
  var $_3s345qr1jg8yozr4 = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_a0gj4qr0jg8yozr2.getPatterns(editor.settings));
    $_3s345qr1jg8yozr4.setup(editor, patternsState);
    return $_g10gorqzjg8yozr1.get(patternsState);
  });
  function Plugin () {
  }
