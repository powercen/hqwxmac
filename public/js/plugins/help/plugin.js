...
var help = (function () {
  ...
  var never$1 = $_8hda6cb1jg8yowaw.never;
  var always$1 = $_8hda6cb1jg8yowaw.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_8hda6cb1jg8yowaw.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_ezbaq7b2jg8yoway.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_2gu9m8azjg8yowao = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_1tk2ryb4jg8yowb2 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_2gu9m8azjg8yowao.map($_1tk2ryb4jg8yowb2.shortcuts, function (shortcut) {
  ...
  var $_c4toh0ayjg8yowaf = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_bde0t2b9jg8yowbu.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_bde0t2b9jg8yowbu.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_bde0t2b9jg8yowbu.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_bde0t2b9jg8yowbu.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_4bayjrbajg8yowbw.head(str).bind(function (head) {
      return $_4bayjrbajg8yowbw.tail(str).map(function (tail) {
  ...
  var $_fh3dqobbjg8yowby = { urls: urls };

  var makeLink = $_8hda6cb1jg8yowaw.curry($_51mcovb8jg8yowbo.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_2gu9m8azjg8yowao.find($_fh3dqobbjg8yowby.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_9h6k91b7jg8yowbl.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_2gu9m8azjg8yowao.filter(keys, $_8hda6cb1jg8yowaw.not($_8hda6cb1jg8yowaw.curry($_2gu9m8azjg8yowao.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_2gu9m8azjg8yowao.map(pluginKeys, function (key) {
  ...
  var $_fzg9rlb6jg8yowb4 = { makeTab: makeTab$1 };
  ...
  var $_bsgvifbcjg8yowc0 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_c4toh0ayjg8yowaf.makeTab(),
          $_fzg9rlb6jg8yowb4.makeTab(editor)
        ],
        buttons: $_bsgvifbcjg8yowc0.makeRow(),
  ...
  var $_dcxrkoaxjg8yowae = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_dcxrkoaxjg8yowae.open(editor, pluginUrl));
  };
  var $_cyqe01awjg8yowac = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_dcxrkoaxjg8yowae.open(editor, pluginUrl)
    });
  ...
  var $_8ux1d7bejg8yowc1 = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_8ux1d7bejg8yowc1.register(editor, pluginUrl);
    $_cyqe01awjg8yowac.register(editor, pluginUrl);
