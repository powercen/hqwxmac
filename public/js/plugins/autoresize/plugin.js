...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_4fnbf08njg8yow30.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_4fnbf08njg8yow30.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_4fnbf08njg8yow30.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_4fnbf08njg8yow30.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_4fnbf08njg8yow30.getAutoResizeBottomMargin(editor);
    ...
    if ($_4fnbf08njg8yow30.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_ahejtw8kjg8yow2x.resize(editor, oldSize);
    });
  };
  var $_djfdjw8jjg8yow2w = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_djfdjw8jjg8yow2w.register(editor, oldSize);
      $_ahejtw8kjg8yow2x.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
