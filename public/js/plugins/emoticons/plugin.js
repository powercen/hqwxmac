...
var emoticons = (function () {
  ...
  var $_buz304asjg8yowa2 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_buz304asjg8yowa2.getHtml(pluginUrl);
  ...
  var $_lyub7arjg8yowa1 = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_lyub7arjg8yowa1.register(editor, pluginUrl);
  });
  function Plugin () {
  }
