...
var contextmenu = (function () {
  ...
  var $_ojp3fadjg8yow91 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_6smijkacjg8yow8z.getContextMenu(editor);
  ...
  var $_e2oop1agjg8yow96 = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_6smijkacjg8yow8z.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_e2oop1agjg8yow96.show(editor, $_ojp3fadjg8yow91.getPos(editor, e), visibleState, menu);
    });
  };
  var $_cd84lfabjg8yow8x = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_cd84lfabjg8yow8x.setup(editor, visibleState, menu);
    return $_c5772eaajg8yow8w.get(visibleState);
  });
  function Plugin () {
  }
