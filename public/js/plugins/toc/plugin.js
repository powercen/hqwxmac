...
var toc = (function () {
  ...
  var $_bp440srhjg8yozs0 = { create: create };

  var tocId = $_bp440srhjg8yozs0.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_3tlcpnrgjg8yozry.getTocClass(editor);
    var headerTag = $_3tlcpnrgjg8yozry.getTocHeader(editor);
    var selector = generateSelector($_3tlcpnrgjg8yozry.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_3tlcpnrgjg8yozry.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_3tlcpnrgjg8yozry.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_1gg078rcjg8yozrv.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_1gg078rcjg8yozrv.updateToc(editor);
    });
  };
  var $_flp4s4rbjg8yozrt = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_3tlcpnrgjg8yozry.getTocClass(editor);
  ...
  var $_6qu0pmrijg8yozs1 = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_1gg078rcjg8yozrv.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_3tlcpnrgjg8yozry.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_90hnxlrjjg8yozs3 = { register: register$1 };

  global.add('toc', function (editor) {
    $_flp4s4rbjg8yozrt.register(editor);
    $_90hnxlrjjg8yozs3.register(editor);
    $_6qu0pmrijg8yozs1.setup(editor);
  });
  function Plugin () {
  }
