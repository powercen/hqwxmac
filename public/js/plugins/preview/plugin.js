...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_a4h1cjipjg8yox3p.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_a4h1cjipjg8yox3p.getPreviewDialogWidth(editor);
    var dialogHeight = $_a4h1cjipjg8yox3p.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_56p359iqjg8yox3r.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_e43jbtinjg8yox3o = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_e43jbtinjg8yox3o.open(editor);
    });
  };
  var $_ay39s6imjg8yox3m = { register: register };
  ...
  var $_ghgx0risjg8yox3t = { register: register$1 };

  global.add('preview', function (editor) {
    $_ay39s6imjg8yox3m.register(editor);
    $_ghgx0risjg8yox3t.register(editor);
  });
  function Plugin () {
  }
