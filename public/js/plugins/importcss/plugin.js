...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_9m8jvqeojg8yowrr.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_9m8jvqeojg8yowrr.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_9m8jvqeojg8yowrr.getSelectorConverter(editor)) {
      selectorConverter = $_9m8jvqeojg8yowrr.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_9m8jvqeojg8yowrr.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_9m8jvqeojg8yowrr.getCssGroups(editor));
      ...
      if (!$_9m8jvqeojg8yowrr.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_9m8jvqeojg8yowrr.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_e2uw0nejjg8yowrn.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_4wugcyeijg8yowrk = { get: get };

  global.add('importcss', function (editor) {
    $_e2uw0nejjg8yowrn.setup(editor);
    return $_4wugcyeijg8yowrk.get(editor);
  });
  function Plugin () {
  }
