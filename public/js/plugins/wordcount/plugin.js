...
var wordcount = (function () {
  ...
  var $_8b5ig4sojg8yozxg = {
    each: each,
    map: map
  };

  var SETS$1 = $_f279kbsmjg8yozxc.SETS;
  var OTHER = $_f279kbsmjg8yozxc.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_8b5ig4sojg8yozxg.map(string.split(''), memoized);
  };
  var $_9226w7snjg8yozxf = { classify: classify };

  var ci = $_f279kbsmjg8yozxc.characterIndices;
  ...
  var $_69tpwdspjg8yozxi = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_f279kbsmjg8yozxc.EMPTY_STRING;
  var WHITESPACE$1 = $_f279kbsmjg8yozxc.WHITESPACE;
  var PUNCTUATION$1 = $_f279kbsmjg8yozxc.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_9226w7snjg8yozxf.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_69tpwdspjg8yozxi.isWordBoundary(map, i)) {
  ...
  var $_d7pzqisljg8yozxa = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_d7pzqisljg8yozxa.getWords(getTextContent(editor)).length;
  };
  var $_8ro86gskjg8yozx8 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_8ro86gskjg8yozx8.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_axt0mtsjjg8yozx7 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_8ro86gskjg8yozx8.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_pcuvxsqjg8yozxk = { setup: setup };

  global.add('wordcount', function (editor) {
    $_pcuvxsqjg8yozxk.setup(editor);
    return $_axt0mtsjjg8yozx7.get(editor);
  });
  function Plugin () {
  }
